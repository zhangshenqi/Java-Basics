...
public class WeightedGraphTest {
    ...
    public static void testGraph(WeightedGraph graph) {
        ...
        System.out.println(graph.getShortestDistances(0));
        System.out.println("Distances from 1");
        System.out.println(graph.getShortestDistances(1));
        System.out.println("Distances from 2");
        System.out.println(graph.getShortestDistances(2));
        System.out.println("Distances from 3");
        System.out.println(graph.getShortestDistances(3));
        System.out.println("Distances from 4");
        System.out.println(graph.getShortestDistances(4));
